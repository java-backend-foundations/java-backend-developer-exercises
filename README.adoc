...
. link:appointment-booking-system-specification.asciidoc[Introduction: Appointment Booking System Specification]: Understand the purpose of the Appointment Booking Service and the key features it will provide.
